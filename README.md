...
For SNP search functionality, the full text search feature of MySQL is used. The `MATCH` and `AGAINST` clauses used to search for a keyword in the `SNP.id` and `SNP.description` columns:
